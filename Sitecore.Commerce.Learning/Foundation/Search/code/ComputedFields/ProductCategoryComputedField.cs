...
{
    public class ProductCategoryComputedField : IComputedIndexField
    {
        ...
        public object ComputeFieldValue(IIndexable indexable)
        {
            ...
            try
            {
                if (contextItem != null)
                {
                    Sitecore.Diagnostics.Log.Info("Inside ProductCategory", this);
                    if (Convert.ToString(contextItem.TemplateID) == commerceProductTemplateId)
                    {
                            ...
                            && contextItem.Parent.Parent.Parent != null && contextItem.Parent.Parent.Parent.Parent != null)
                        {
                            if (contextItem.Parent.Parent.Parent.Parent.DisplayName.ToLower() == rootCategoryName)
                            {
                                ...
                                return contextItem.Parent.Parent.Parent.DisplayName.ToLower();
                            }
            ...
            {
                Sitecore.Diagnostics.Log.Error("ProductCategoryComputedField", ex, "ComputeFieldValue");
            }
